...
- 🐧 Hands-on practice with Linux & RHEL
- ☁️ Learning and working with AWS Cloud
...
AWS Services:  
EC2 IAM VPC S3 CloudFront ECR ECS Fargate ALB Security Groups
...
Skills:  
Linux RHEL Docker Git GitHub GitHub Actions CI/CD AWS CLI Bash
...
GitHub → GitHub Actions → Docker → Amazon ECR → ECS/Fargate → ALB
...
- Hosted a static HTML website using Amazon S3
- Kept the S3 bucket private
- Configured CloudFront with Origin Access Control
- Verified website access through CloudFront
- Practiced AWS security and cloud architecture concepts
...
<h3 align="center">🚀 Learning • Building • Automating • Growing</h3>
